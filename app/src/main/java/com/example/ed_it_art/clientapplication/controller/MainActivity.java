...
DBmanager dBmanager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerReceiver(new ClientReceiver(),
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_yourCar) {
            Intent intent = new Intent(MainActivity.this, ClientCarActivity.class);
            startActivity(intent);
